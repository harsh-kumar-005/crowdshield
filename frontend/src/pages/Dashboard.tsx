  ...
  useEffect(() => {
    ...
    socket.on('crowd_update', (data) => {
      ...
      setHistoricalData(prev => {
        const newData = [...prev, { time: new Date(data.timestamp).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit', second:'2-digit'}), total: data.totalCrowd }];
...
// Extracted reusable StatCard UI
